...
var myTurtle = new Turtle(ctx, maxX/2, 0.9 * maxY, 0);

var sidesInput = document.getElementById("myInput");

let n = parseInt(sidesInput.value);

myTurtle.drawPolygon(n, 0.8 * maxY * Math.sin(Math.PI/n));
